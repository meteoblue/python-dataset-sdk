...
_DATASETAPIPROTOBUF_TIMEINTERVAL = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="start",
            full_name="DatasetApiProtobuf.TimeInterval.start",
            index=1,
            number=2,
            type=18,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="end",
            full_name="DatasetApiProtobuf.TimeInterval.end",
            index=2,
            number=3,
            type=18,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="stride",
            full_name="DatasetApiProtobuf.TimeInterval.stride",
            index=3,
            number=4,
            type=3,
            cpp_type=2,
...
_DATASETAPIPROTOBUF_CODE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="kwPeak",
            full_name="DatasetApiProtobuf.Code.kwPeak",
            index=10,
            number=11,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="efficiency",
            full_name="DatasetApiProtobuf.Code.efficiency",
            index=13,
            number=14,
            type=2,
            cpp_type=6,
        ...
        _descriptor.FieldDescriptor(
            name="tracker",
            full_name="DatasetApiProtobuf.Code.tracker",
            index=14,
            number=15,
            type=3,
            cpp_type=2,
